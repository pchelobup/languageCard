...
class CardServiceTest extends ServiceTest {
    ...
    void createWithException() {
        validateRootCause(ConstraintViolationException.class, () -> cardService.create(new Card(null, getNew().getTranslation()), USER1_ID));
        validateRootCause(ConstraintViolationException.class, () -> cardService.create(new Card(" ", getNew().getTranslation()), USER1_ID));
        validateRootCause(ConstraintViolationException.class, () -> cardService.create(new Card(getNew().getWord(), null), USER1_ID));
        validateRootCause(ConstraintViolationException.class, () -> cardService.create(new Card(getNew().getWord(), " "), USER1_ID));
    }
